import svgPaths from "./svg-co7pc92h1d";
import img202510241502261 from "figma:asset/8fbd6c23deb5b73222d21951d6be07772dd2507f.png";
import imgImage3 from "figma:asset/c1848150b16b2699d20bf1aa7c7012cc35258859.png";
...
function Frame4() {
  return (
    <div className="content-stretch flex gap-[6px] items-center justify-end opacity-0 relative self-stretch shrink-0 w-[113px]">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] not-italic relative shrink-0 text-[#ea4310] text-[12px] tracking-[0.01px]">от 25.03</p>
...
function Frame5() {
  return (
    <div className="content-stretch flex gap-[4px] items-start relative shrink-0 w-full">
      <div className="flex flex-[1_0_0] flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#ea4310] text-[24px] tracking-[-0.47px]">
        <p className="leading-[1.3] whitespace-pre-wrap">156</p>
      </div>
      <Frame4 />
    </div>
  );
...
function Frame() {
  return (
    <div className="content-stretch flex gap-[2px] items-center overflow-clip relative rounded-[40px] shrink-0 w-full">
      <div className="bg-[#ea4310] flex-[1_0_0] h-[4px] min-h-px min-w-px" />
      <div className="bg-[#f8dddd] flex-[1_0_0] h-[4px] min-h-px min-w-px" />
      <div className="bg-[#f8dddd] flex-[1_0_0] h-[4px] min-h-px min-w-px" />
      <div className="bg-[#f8dddd] flex-[1_0_0] h-[4px] min-h-px min-w-px" />
      <div className="bg-[#f8dddd] flex-[1_0_0] h-[4px] min-h-px min-w-px" />
    </div>
...
function Frame3() {
  return (
    <div className="content-stretch flex flex-col items-start overflow-clip relative shrink-0 w-full">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[1.5] not-italic relative shrink-0 text-[#ea4310] text-[10px] tracking-[0.8px] uppercase w-full whitespace-pre-wrap">низкий финансовый рейтинг</p>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex items-center relative shrink-0">
      <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#32393e] text-[24px] text-center tracking-[-0.18px] whitespace-nowrap">
        <p className="leading-[1.4]">{`2 789 000 ₽ `}</p>
      </div>
    </div>
  );
}
...
function Frame13() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full">
      <Frame8 />
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#32393e] text-[12px] w-[276px]">
  ...
  return (
    <div className="content-stretch flex font-['Inter:Semi_Bold',sans-serif] font-semibold gap-[4px] items-center relative shrink-0 text-[24px] text-center tracking-[-0.18px] whitespace-nowrap">
      <div className="flex flex-col justify-center relative shrink-0 text-[#32393e]">
        <p className="leading-[1.4]">{`168 789 ₽/мес `}</p>
      </div>
      <div className="flex flex-col justify-center relative shrink-0 text-[#ea4310]">
        <p className="leading-[1.4]">75%</p>
      </div>
    </div>
  );
}
...
function Frame14() {
  return (
    <div className="content-stretch flex flex-col items-start leading-[0] not-italic relative shrink-0 w-full">
      <Frame9 />
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center relative shrink-0 text-[#32393e] text-[12px] w-[275px]">
    ...
    <div className="content-stretch flex gap-[8px] items-center min-h-[18px] relative shrink-0" data-name="row">
      ...
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#858585] text-[0px] whitespace-nowrap">
        <p className="text-[#32393e] text-[12px]">
          ...
          <span className="font-['Inter:Regular',sans-serif] font-normal leading-[1.5] not-italic">{` есть`}</span>
        </p>
      </div>
    </div>
  );
...
function Component24PxOutlineDangerous() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="24 px | Outline / dangerous">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="24 px | Outline / dangerous">
          <path d={svgPaths.p3b1de40} fill="var(--fill-0, #EA4310)" id="Vector" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start justify-center leading-[0] min-h-px min-w-px not-italic relative" data-name="Title subtitle">
      <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center relative shrink-0 text-[#32383d] text-[16px] tracking-[-0.18px] w-full">
        <p className="leading-[1.4] whitespace-pre-wrap">Предварительно не одобрен</p>
      </div>
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center relative shrink-0 text-[#858585] text-[14px] w-full">
        <p className="leading-[1.4] whitespace-pre-wrap">{`Банк не одобрит клиента, сначала исправьте `}</p>
      </div>
    </div>
  );
}
...
function SystemBanner() {
  return (
    <div className="bg-[rgba(234,67,16,0.15)] content-stretch flex flex-col items-start p-[16px] relative rounded-[8px] shrink-0 w-[564px]" data-name="SystemBanner">
      <Container />
    </div>
  );
}
...
function Frame17() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-[564px]">
      ...
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center relative shrink-0 text-[0px] w-full">
        <ul className="list-disc whitespace-pre-wrap">
          <li className="mb-0 ms-[calc(var(--list-marker-font-size,0)*1.5*1)]">
            <span className="leading-[1.4] text-[14px]">Снизить ПДН — изучите список действующих кредитов</span>
          </li>
          <li className="mb-0 ms-[calc(var(--list-marker-font-size,0)*1.5*1)] text-[14px]">
            <span className="leading-[1.4]">{`Снизить ПДН `}</span>
            <span className="font-['Inter:Regular',sans-serif] font-normal leading-[1.4] not-italic">—</span>
            <span className="leading-[1.4]">{` привлечь созаемщика с доходом`}</span>
          </li>
          <li className="mb-0 ms-[calc(var(--list-marker-font-size,0)*1.5*1)] text-[14px]">
            <span className="leading-[1.4]">{`ФССП `}</span>
            <span className="font-['Inter:Regular',sans-serif] font-normal leading-[1.4] not-italic">—</span>
            <span className="leading-[1.4]">{` погасить долги`}</span>
          </li>
          <li className="ms-[calc(var(--list-marker-font-size,0)*1.5*1)]">
            <span className="leading-[1.4] text-[14px]">Текущая просрочка 1+</span>
          </li>
        </ul>
      </div>
    </div>
      ...
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center relative shrink-0 text-[14px] w-full">
        <ul className="list-disc whitespace-pre-wrap">
          <li className="mb-0 ms-[21px]">
            <span className="leading-[1.4]">Текущая просрочка 30+</span>
          </li>
          <li className="mb-0 ms-[21px]">
            <span className="leading-[1.4]">Историческая просрочка 30+ за 3 года</span>
          </li>
          <li className="mb-0 ms-[21px]">
            <span className="leading-[1.4]">Историческая просрочка 90+ за 3 года</span>
          </li>
          <li className="ms-[21px]">
            <span className="leading-[1.4]">Полученные МФО кредита за 6 месяцев</span>
          </li>
        </ul>
      </div>
    </div>
  ...
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start leading-[0] not-italic relative shrink-0 whitespace-nowrap">
      <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center relative shrink-0 text-[#32393e] text-[16px] tracking-[-0.18px]">
        <p className="leading-[1.4]">9 действующих кредитов</p>
      </div>
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center relative shrink-0 text-[#858585] text-[14px]">
        <p className="leading-[1.4]">На сумму 8 890 567 ₽</p>
      </div>
    </div>
  );
}
...
function MainButton() {
  return (
    <div className="bg-[rgba(85,147,247,0.05)] content-stretch flex gap-[4px] items-center justify-center px-[12px] py-[9px] relative rounded-[8px] shrink-0" data-name="Main button">
      <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#2474f5] text-[12px] text-center whitespace-nowrap">
        <p className="leading-[1.5]">Посмотреть</p>
      </div>
    </div>
  );
}
...
function Frame24() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0 w-[275px]">
      ...
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[1.5] not-italic relative shrink-0 text-[#858585] text-[12px]">Кредитный отчет ОКБ</p>
    </div>
  );
}
...
function MainContainer() {
  return (
    <div className="content-stretch flex flex-col gap-[64px] items-start px-[8px] relative shrink-0 w-[886px]" data-name="Main Container">
      <FormContainer />
      <Footer />
    </div>
  );
...
function RightContainer() {
  return (
    <div className="content-stretch flex flex-col gap-[30px] items-start pt-[32px] px-[8px] shrink-0 sticky top-0 w-[488px]" data-name="Right Container">
      <SidebarCardClients />
...
function Component1() {
  return (
    <div className="content-stretch flex items-start justify-between pb-[64px] relative shrink-0 w-[1520px]" data-name="контейнер">
      <MainContainer />
      <RightContainer />
    </div>
  );
...
function Group3() {
  return (
    <div className="h-[20.001px] relative shrink-0 w-[42.323px]">
