import svgPaths from "./svg-21hdjvsbiq";
...
function Content() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="content">
      <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#a4adb2] text-[12px] tracking-[0.01px] whitespace-nowrap">
...
function Frame4() {
  return (
    <div className="content-stretch flex gap-[6px] items-center justify-end opacity-0 relative self-stretch shrink-0 w-[113px]">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] not-italic relative shrink-0 text-[#a4adb2] text-[12px] tracking-[0.01px]">от 25.03</p>
...
function Frame5() {
  return (
    <div className="content-stretch flex gap-[4px] items-start relative shrink-0 w-full">
      <div className="flex flex-[1_0_0] flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] min-h-px min-w-px not-italic opacity-0 relative text-[#a4adb2] text-[36px] tracking-[-0.79px]">
        <p className="leading-[1.3] whitespace-pre-wrap">697</p>
      </div>
      <Frame4 />
    </div>
  );
...
function Frame() {
  return (
    <div className="content-stretch flex gap-[2px] items-center overflow-clip relative rounded-[40px] shrink-0 w-full">
      <div className="bg-[rgba(24,64,123,0.05)] flex-[1_0_0] h-[4px] min-h-px min-w-px" />
      <div className="bg-[rgba(24,64,123,0.05)] flex-[1_0_0] h-[4px] min-h-px min-w-px" />
      <div className="bg-[rgba(24,64,123,0.05)] flex-[1_0_0] h-[4px] min-h-px min-w-px" />
      <div className="bg-[rgba(24,64,123,0.05)] flex-[1_0_0] h-[4px] min-h-px min-w-px" />
      <div className="bg-[rgba(24,64,123,0.05)] flex-[1_0_0] h-[4px] min-h-px min-w-px" />
...
function Frame3() {
  return (
    <div className="content-stretch flex flex-col items-start overflow-clip relative shrink-0 w-full">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[#a4adb2] text-[9px] tracking-[0.63px] uppercase w-full whitespace-pre-wrap">финансовый рейтинг</p>
    </div>
  );
}
...
function SkeletonItem() {
  return (
    <div className="h-[16px] opacity-8 relative rounded-[4px] shrink-0 w-[135px]" data-name="SkeletonItem">
      <div className="absolute bg-[#a4adb2] inset-0 rounded-[4px]" data-name="Background" />
    </div>
  );
}

function SkeletonItem1() {
  return (
    <div className="h-[16px] opacity-8 relative rounded-[4px] shrink-0 w-[212px]" data-name="SkeletonItem">
      <div className="absolute bg-[#a4adb2] inset-0 rounded-[4px]" data-name="Background" />
    </div>
  );
}
...
function Frame12() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[6px] items-start min-h-px min-w-px relative self-stretch">
      <SkeletonItem />
      <SkeletonItem1 />
    </div>
  );
...
function Frame13() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[3px] items-start min-h-px min-w-px relative self-stretch">
      <SkeletonItem2 />
      <SkeletonItem3 />
    </div>
  );
...
function RoundBadge() {
  return (
    <div className="bg-[rgba(222,222,222,0.6)] max-h-[8px] max-w-[8px] min-h-[8px] min-w-[8px] relative rounded-[20px] shrink-0 size-[8px]" data-name="RoundBadge">
...
function Row() {
  return (
    <div className="content-stretch flex gap-[8px] items-center min-h-[18px] relative shrink-0" data-name="row">
      <RoundBadge />
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#a4adb2] text-[12px] whitespace-nowrap">
        <p className="leading-[1.5]">Статус банкрота</p>
      </div>
    </div>
  );
}
...
function Row1() {
  return (
    <div className="content-stretch flex gap-[8px] items-center min-h-[18px] relative shrink-0" data-name="row">
      <RoundBadge1 />
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#a4adb2] text-[12px] whitespace-nowrap">
        <p className="leading-[1.5]">Просрочки</p>
      </div>
    </div>
  );
}
...
function Component2() {
  return (
    <div className="content-stretch flex gap-[8px] items-center min-h-[18px] relative shrink-0 w-full" data-name="1">
      <RoundBadge2 />
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#a4adb2] text-[0px] whitespace-nowrap">
        <p className="text-[12px]">
          <span className="leading-[1.5]">Д</span>
          <span className="font-['Inter:Regular',sans-serif] font-normal leading-[1.5] not-italic">олг ФССП</span>
        </p>
      </div>
    </div>
  );
  ...
  return (
    <div className="content-stretch flex gap-[8px] items-center min-h-[18px] relative shrink-0" data-name="row">
      ...
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#a4adb2] text-[0px] whitespace-nowrap">
        <p className="text-[12px]">
          <span className="leading-[1.5]">Д</span>
          <span className="font-['Inter:Regular',sans-serif] font-normal leading-[1.5] not-italic">олг по налогам</span>
        </p>
      </div>
    </div>
  );
...
function Row3() {
  return (
    <div className="content-stretch flex gap-[8px] items-center min-h-[18px] relative shrink-0" data-name="row">
      <RoundBadge4 />
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#a4adb2] text-[12px] whitespace-nowrap">
        <p className="leading-[1.5]">Самозапрет</p>
      </div>
    </div>
  );
}
...
function SkeletonItem4() {
  return (
    <div className="h-[16px] opacity-8 relative rounded-[4px] shrink-0 w-[117px]" data-name="SkeletonItem">
      <div className="absolute bg-[#a4adb2] inset-0 rounded-[4px]" data-name="Background" />
    </div>
  );
}

function SkeletonItem5() {
  return (
    <div className="h-[16px] opacity-8 relative rounded-[4px] shrink-0 w-full" data-name="SkeletonItem">
      <div className="absolute bg-[#a4adb2] inset-0 rounded-[4px]" data-name="Background" />
    </div>
  );
}

function SkeletonItem6() {
  return (
    <div className="h-[16px] opacity-8 relative rounded-[4px] shrink-0 w-[274px]" data-name="SkeletonItem">
      <div className="absolute bg-[#a4adb2] inset-0 rounded-[4px]" data-name="Background" />
    </div>
  );
}
...
function Frame10() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[11px] items-start min-h-px min-w-px relative">
      <SkeletonItem4 />
      <SkeletonItem5 />
      <SkeletonItem6 />
    </div>
...
function Component24PxOutlineOpenInNew() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="24 px | Outline / open_in_new">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="24 px | Outline / open_in_new">
          <path d={svgPaths.pef7fc00} fill="var(--fill-0, #32393E)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function MainButton() {
  return (
    <div className="bg-[rgba(5,31,81,0.04)] content-stretch flex gap-[4px] items-center justify-center opacity-0 px-[8px] py-[6px] relative rounded-[8px] shrink-0" data-name="Main button">
      <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#32393e] text-[12px] text-center whitespace-nowrap">
        <p className="leading-[1.5]">Больше результатов</p>
      </div>
      <Component24PxOutlineOpenInNew />
    </div>
  );
}
      ...
      <div className="h-0 relative shrink-0 w-full">
        <div className="absolute inset-[-1px_0_0_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 870 1">
            <line id="Line 3" stroke="var(--stroke-0, #18407B)" strokeOpacity="0.05" x2="870" y1="0.5" y2="0.5" />
          </svg>
        </div>
      </div>
      <Frame18 />
