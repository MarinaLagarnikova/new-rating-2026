import svgPaths from "./svg-mv356uwoi5";
...
function Frame4() {
  return (
    <div className="content-stretch flex gap-[6px] items-center justify-end opacity-0 relative self-stretch shrink-0 w-[113px]">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] not-italic relative shrink-0 text-[#ce6809] text-[12px] tracking-[0.01px]">от 25.03</p>
...
function Frame5() {
  return (
    <div className="content-stretch flex gap-[4px] items-start relative shrink-0 w-full">
      <div className="flex flex-[1_0_0] flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#ce6809] text-[24px] tracking-[-0.47px]">
...
function Frame() {
  return (
    <div className="content-stretch flex gap-[2px] items-center overflow-clip relative rounded-[40px] shrink-0 w-full">
      <div className="bg-[#ce6809] flex-[1_0_0] h-[4px] min-h-px min-w-px" />
      <div className="bg-[#ce6809] flex-[1_0_0] h-[4px] min-h-px min-w-px" />
      <div className="bg-[#ce6809] flex-[1_0_0] h-[4px] min-h-px min-w-px" />
      <div className="bg-[#ce6809] flex-[1_0_0] h-[4px] min-h-px min-w-px" />
...
function Frame3() {
  return (
    <div className="content-stretch flex flex-col items-start overflow-clip relative shrink-0 w-full">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[1.5] not-italic relative shrink-0 text-[#ce6809] text-[10px] tracking-[0.8px] uppercase w-full whitespace-pre-wrap">Хороший финансовый рейтинг</p>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex items-center relative shrink-0">
      <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#32393e] text-[24px] text-center tracking-[-0.18px] whitespace-nowrap">
        <p className="leading-[1.4]">{`20 000 000 ₽ `}</p>
      </div>
    </div>
  );
}
...
function Frame9() {
  return (
    <div className="content-stretch flex font-['Inter:Semi_Bold',sans-serif] font-semibold gap-[4px] items-center relative shrink-0 text-[24px] text-center tracking-[-0.18px] whitespace-nowrap">
      ...
      <div className="flex flex-col justify-center relative shrink-0 text-[#ce6809]">
        <p className="leading-[1.4]">55%</p>
      </div>
    </div>
  );
}
...
function Component24PxBoldWarning() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="24 px | Bold / warning">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="24 px | Bold / warning">
          <path d={svgPaths.p123fe000} fill="var(--fill-0, #FFC533)" id="Vector" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start justify-center leading-[0] min-h-px min-w-px not-italic relative" data-name="Title subtitle">
      <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center relative shrink-0 text-[#32383d] text-[16px] tracking-[-0.18px] w-full">
        <p className="leading-[1.4] whitespace-pre-wrap">Требуется проверка</p>
      </div>
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center relative shrink-0 text-[#858585] text-[14px] w-full">
        <p className="leading-[1.4] whitespace-pre-wrap">Посмотрите что можно исправить, чтобы повысить шансы</p>
      </div>
    </div>
  );
}
...
function SystemBanner() {
  return (
    <div className="bg-[rgba(255,197,51,0.15)] content-stretch flex flex-col items-start p-[16px] relative rounded-[8px] shrink-0 w-[564px]" data-name="SystemBanner">
      <Container />
    </div>
  );
}
